...
let qouteDisplay = document.querySelector(".qoute");
...
let qoutes = [
  ...
  {
    qoute:
      "Sometimes you wont know the value of a moment until it becomes a MEMORY",
    person: "Dr. Seuss",
  },
  {
  ...
  {
    qoute:
      "I didn't grow up having role models, I grew up having people I didn't want to be like and seeing situations I'd never want to be in. Not all of us are dealt the right cards, but that doesn't mean you can't re-shuffle your deck for a better outcome.",
    person: "Bang",
  },
];
...
btn.addEventListener("click", function () {
  ...
  qouteDisplay.innerHTML = qoutes[random].qoute;
